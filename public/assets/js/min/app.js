...
_vue2.default.component('equalizer', __webpack_require__(7));
...
Component.options.__file = "public/assets/js/src/components/equalizer.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-c3b29cb4", Component.options)
  } else {
    hotAPI.reload("data-v-c3b29cb4", Component.options)
  }
...
var _chunk = __webpack_require__(11);
...
exports.default = {
    ...
    data: function data() {
        return {
            ...
            equalize: (0, _debounce2.default)(function () {
                var _this = this;

                var breakpoint = this.getCurrentBreakpoint(); // get current breakpoint
                var itemsPerRow = this.config[breakpoint]; // get items per row for that breakpoint
                ...
                this.classes.forEach(function (elemClass) {
                    ...
                    var eqItems = [].concat(_toConsumableArray(_this.$el.querySelectorAll("." + elemClass)));
                    switch (true) {
                        case itemsPerRow > 1:
                            // If items per row specified, split items into rows and set height by row
                            var rows = (0, _chunk2.default)(eqItems, itemsPerRow);
                            rows.forEach(function (row) {
                                _this.setMaxHeight(row, false);
                            });
                            break;
                        case itemsPerRow === 1:
                            // if 1 item per row, then height set to auto
                            _this.setMaxHeight(eqItems, true);
                            break;
                        default:
                            // If not specified, just make all items equal height
                            _this.setMaxHeight(eqItems, false);
                    }
                });
            }, 100)
        };
    ...
    methods: {
        ...
        setMaxHeight: function setMaxHeight(items, auto) {
            (0, _imagesloaded2.default)(items, function () {
...
var render = function() {
  ...
  return _c("div", { staticClass: "eq-container" }, [_vm._t("default")], 2)
}
var staticRenderFns = []
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-c3b29cb4", module.exports)
  }
}
